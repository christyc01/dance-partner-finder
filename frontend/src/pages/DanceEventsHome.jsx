...
const DanceEventsHome = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center md:p-4">
      <div className="w-full xl:w-3/4">
        <BackButton />
        <div className="flex justify-between">
          <h1 className="text-3xl font-bold my-2 text-emerald-600">
            Dance Events
          </h1>
                ...
                danceEventData.data.map((event) => (
                  ...
                  >
                    ...
                    <p className="line-clamp-5">
                      ...
                      cupiditate voluptas? Quis atque earum voluptate dolor nisi
                      dolorum est? Deserunt placeat cumque quo dicta architecto,
                      dolore vitae voluptate sequi repellat
                    </p>
